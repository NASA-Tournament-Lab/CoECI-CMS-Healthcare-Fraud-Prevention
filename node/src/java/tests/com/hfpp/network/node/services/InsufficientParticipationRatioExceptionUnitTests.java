...
public class InsufficientParticipationRatioExceptionUnitTests {
     ...
     * <code>NetworkNodeServiceException</code>.
     * </p>
     */
    @Test
    public void testInheritance() {
        assertTrue("InsufficientParticipationRatioException should be subclass of NetworkNodeServiceException.",
            InsufficientParticipationRatioException.class.getSuperclass() == NetworkNodeServiceException.class);
    }
