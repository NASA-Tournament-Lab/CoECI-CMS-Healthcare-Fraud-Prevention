...
import com.hfpp.network.node.services.impl.DataExchangeServiceImpl;

/**
 * <p>
 * Unit tests for {@link NetworkNodeHTTPServicesController} class.
 * </p>
 *
 * @author sparemax
 * @version 1.0
 */
public class NetworkNodeHTTPServicesControllerUnitTests {
    /**
     * <p>
     * Represents the <code>NetworkNodeHTTPServicesController</code> instance used in tests.
     * </p>
     */
    private NetworkNodeHTTPServicesController instance;
     ...
     * </p>
     */
    private DataExchangeServiceImpl dataExchangeService;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(NetworkNodeHTTPServicesControllerUnitTests.class);
    }
    ...
    public void setUp() throws Exception {
        instance = new NetworkNodeHTTPServicesController();
        ...
        dataExchangeService = new DataExchangeServiceImpl();
        dataExchangeService.setJmsTemplate(jmsTemplate);
        dataExchangeService.setSchemaPaths(schemaPaths);
        dataExchangeService.checkConfiguration();

        instance.setDataExchangeService(dataExchangeService);
    ...
    /**
     * <p>
     * Accuracy test for the constructor <code>NetworkNodeHTTPServicesController()</code>.<br>
    ...
    public void testCtor() {
        ...
        assertNull("'dataExchangeService' should be correct.",
            TestsHelper.getField(instance, "dataExchangeService"));
    }
