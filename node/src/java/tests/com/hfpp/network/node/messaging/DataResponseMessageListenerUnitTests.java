 ...
 * @version 1.0
 */
public class DataResponseMessageListenerUnitTests {
    /**
     * <p>
     * Represents the <code>DataResponseMessageListener</code> instance used in tests.
     * </p>
     */
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(DataResponseMessageListenerUnitTests.class);
    }
    ...
    public void setUp() throws Exception {
        instance = new DataResponseMessageListener();
    ...
    /**
     * <p>
     * Accuracy test for the constructor <code>DataResponseMessageListener()</code>.<br>
