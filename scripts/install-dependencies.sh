...
function aptgetDependencies() {
    ...
    sudo apt-get install -y gcc g++ libreadline-dev zlib1g-dev openssl libssl-dev libxml2-dev libxslt-dev sqlite3 libsqlite3-dev

    # study/WeasyPrint dependencies
    echo "Install study/WeasyPrint dependencies..."
    sudo apt-get install -y libxml2-dev
    sudo ln -s /usr/include/libxml2/libxml /usr/include/libxml
    sudo apt-get install -y libxslt-dev libffi-dev
    # JDK/MySQL/Ant
...
downloadFile WeasyPrint-master https://github.com/Kozea/WeasyPrint/archive/master.zip
