...
public class AuthorizationExceptionUnitTests {
    ...
    /**
     * <p>
     * <code>AuthorizationException</code> should be subclass of <code>NetworkHubServiceException</code>.
     * </p>
     */
    @Test
    public void testInheritance() {
        assertTrue("AuthorizationException should be subclass of NetworkHubServiceException.",
            AuthorizationException.class.getSuperclass() == NetworkHubServiceException.class);
    }
