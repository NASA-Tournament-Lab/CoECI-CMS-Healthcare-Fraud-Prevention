...
public class AuthenticationExceptionUnitTests {
    ...
    /**
     * <p>
     * <code>AuthenticationException</code> should be subclass of <code>NetworkHubServiceException</code>.
     * </p>
     */
    @Test
    public void testInheritance() {
        assertTrue("AuthenticationException should be subclass of NetworkHubServiceException.",
            AuthenticationException.class.getSuperclass() == NetworkHubServiceException.class);
    }
